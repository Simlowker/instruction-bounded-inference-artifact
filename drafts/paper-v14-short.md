...
- **Reproduction repository**: `github.com/Simlowker/comoto-paper-artifact` — the end-to-end local rebuild of the 2.9× fork gap (`REPRODUCE.md`) and its result log (`results/rebench_2026-05-19.md`). Made public at deposit.
...
| --- | --- | --- | --- |
| Qwen 2.5 0.5B Q8_0 GGUF | `comoto-paper-artifact` / `REPRODUCE.md` | `ca59ca7f…6844e` | §4.1 mainnet 29-vs-10 |
