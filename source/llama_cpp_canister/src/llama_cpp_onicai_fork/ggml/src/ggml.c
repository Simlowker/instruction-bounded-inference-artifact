...
#ifdef __wasi__
    return; // WASI/ICP: getenv() crashes, no backtrace support
#else
...
// WASI-PATCH: GGML_VERSION/GGML_COMMIT normally set by CMake — provide fallbacks
#ifndef GGML_VERSION
#define GGML_VERSION "0.9.11"
#endif
#ifndef GGML_COMMIT
#define GGML_COMMIT "upstream"
#endif
