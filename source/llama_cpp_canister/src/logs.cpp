...
void remove_log_file() {
  ...
  // common_log_remove_file was removed upstream — stub with no-op
  // Upstream llama.cpp no longer supports per-file log removal via the common_log API.
  std::string msg = "Log file removal not supported in upstream llama.cpp";
